 ...
 * @author victor
 */
public class VagaCandidatoJF extends javax.swing.JInternalFrame {
    ...
    Candidato cand;
    CandidatoVagaController candVaC;
    CandidatoVaga candV;
    
    public VagaCandidatoJF() {
        initComponents();
        ...
        populaEmpresa();
        cand = new Candidato();
        candVaC = new CandidatoVagaController();
    ...
    private void B_gravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_gravarActionPerformed
        ...
        candVaC.salvaCandidatoVaga(vagaId, cand);
    ...
    private void B_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_buscarActionPerformed
         ...
         PessoaJuridica p = null;
          try { 
          c = (Curso)Combo_curso.getSelectedItem();
         ...
         if(!vagaC.pupularTabela(mTable,cod,c,p)){
